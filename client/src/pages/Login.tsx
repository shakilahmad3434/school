...
const Login = () => {
    ...
    return (
       <div className="bg-gray-100 relative min-h-screen flex justify-center items-center px-2 py-5 md:px-10 md:py-10 overflow-hidden font-poppins">
            ...
            <div className="max-w-md w-full space-y-5 rounded-xl shadow-xl p-5 bg-white/5 backdrop-blur-md border border-white/20 text-white animate__animated animate__slideInDown animate__faster">
